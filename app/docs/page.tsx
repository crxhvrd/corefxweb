    ...
    <main className="min-h-screen pt-6 sm:pt-8">
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-8 flex flex-col lg:flex-row gap-4 sm:gap-6 md:gap-8">
        ...
        <div className="relative w-full lg:flex-1">
          <ScrollArea className="w-full max-h-none sm:max-h-[calc(100vh-6rem)] bg-black/20 backdrop-blur-md rounded-lg overflow-hidden">
          ...
          <div className="hidden sm:block absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-black/40 to-transparent rounded-b-lg pointer-events-none" />
        </div>
